...
Высота поля адаптируется в зависимости от текста с помощью атрибута `data-autoheight` (свойство `autoheight`). Это свойство (html-атрибут) нужно применять **после** установки свойства (html-атрибута) `value`.

<Canvas>
  <base-textarea value="" data-autoheight label="Без текста и со стандартным rows"></base-textarea>
  <base-textarea value="Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate accusantium nobis ipsa sapiente laboriosam deserunt rem. Impedit distinctio est ut nulla voluptatem aspernatur libero temporibus, beatae necessitatibus commodi dignissimos veniam!" data-autoheight label="С текстом и без rows" rows="0"></base-textarea>
  <base-textarea value="Lorem ipsum dolor sit amet consectetur adipisicing elit." data-autoheight label="С текстом и с rows" title="С текстом и с rows" rows="5"></base-textarea>
</Canvas>
...
code={`
<base-textarea value="" data-autoheight label="Без текста и со стандартным rows"></base-textarea>
<base-textarea value="Lorem ipsum dolor..." data-autoheight label="С текстом и без rows" rows="0"></base-textarea>
<base-textarea value="Lorem ipsum dolor..." data-autoheight label="С текстом и с rows" rows="5"></base-textarea>
`}
/>
...
<Canvas>
  <base-textarea minlength="5"></base-textarea>
</Canvas>
